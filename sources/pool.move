module aptosswap::pool {
    ...
    use aptosswap::ratio::{ Self };
    use aptosswap::permission::{ Permission };
    use aptosswap::TOKEN::{ Self as token, StakedToken, TokenFarm, TokenCap, TokenBank };
    use aptosswap::vpt::{ Self, ValuePerToken };
    ...
    /// we could create both Aptos/USDC pool and USDC/Aptos. The reasons for such
    /// design are:
    /// 
